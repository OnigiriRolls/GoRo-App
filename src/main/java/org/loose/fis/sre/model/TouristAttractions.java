...
public class TouristAttractions {
    ...
    public TouristAttractions(String title, String photoTitle, String availability, String description, float price) {
        this.title = title;
    ...
    public boolean equals(Object o) {
        ...
        TouristAttractions tatr = (TouristAttractions) o;
